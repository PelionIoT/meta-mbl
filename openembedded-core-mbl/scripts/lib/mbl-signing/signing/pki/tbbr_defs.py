...
trusted_boot_fw_cert = X509CertificateExtensions(
    ...
    dict(
        ...
        TRUSTED_BOOT_FW_CONFIG_HASH=HashExtension(
            oid="1.3.6.1.4.1.4128.2100.202", critical=True
        ),
        HW_CONFIG_HASH=HashExtension(
            oid="1.3.6.1.4.1.4128.2100.203", critical=True
        ),
    ),
...
soc_fw_content_cert = X509CertificateExtensions(
    ...
    dict(
        ...
        APROM_PATCH_HASH=HashExtension(
            oid="1.3.6.1.4.1.4128.2100.601", critical=False
        ),
        SOC_CONFIG_HASH=HashExtension(
            oid="1.3.6.1.4.1.4128.2100.602", critical=True
        ),
...
scp_firmware_content_cert = X509CertificateExtensions(
    ...
    dict(
        SCP_FW_HASH=HashExtension(
            oid="1.3.6.1.4.1.4128.2100.801", critical=False
        ),
...
trusted_os_firmware_content_cert = X509CertificateExtensions(
    ...
    dict(
        ...
        TRUSTED_OS_FW_CONFIG_HASH=HashExtension(
            oid="1.3.6.1.4.1.4128.2100.1004", critical=False, content_file=None
        ),
    ),
...
non_trusted_firmware_content_cert = X509CertificateExtensions(
    ...
    dict(
        ...
        NON_TRUSTED_FW_CONFIG_HASH=HashExtension(
            oid="1.3.6.1.4.1.4128.2100.1202", critical=False, content_file=None
        ),
    ),
...
cot_certs = {
    ...
    "tos-fw-cert": trusted_os_firmware_key_cert,
    "soc-fw-key-cert": soc_fw_key_cert,
    "nt-fw-key-cert": non_trusted_firmware_key_cert,
    "tos-fw-key-cert": trusted_os_firmware_content_cert,
