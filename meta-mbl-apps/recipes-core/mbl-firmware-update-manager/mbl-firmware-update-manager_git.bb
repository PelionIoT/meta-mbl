...
DESCRIPTION="Provided with an update component, this entity will will install and run the new component. It provides an alternative entry point into the update code other than mbl cloud client."
