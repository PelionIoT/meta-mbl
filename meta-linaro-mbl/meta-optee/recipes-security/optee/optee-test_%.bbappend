...
SRC_URI_imx8mmevk-mbl = "git://github.com/OP-TEE/optee_test.git \
			file://0001a-Turn-off-GCC-format-overflow-checking-for-xtest.patch \
			file://0013-xtest-prevent-unexpected-build-warning-with-strncpy.patch \
