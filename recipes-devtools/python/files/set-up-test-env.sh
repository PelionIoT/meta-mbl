...
export PATH=__REPLACE_ME_WITH_MBL_APP_DIR__/__REPLACE_ME_WITH_bindir__
export LD_LIBRARY_PATH=__REPLACE_ME_WITH_MBL_APP_DIR__/__REPLACE_ME_WITH_libdir__
export PYTEST_ADDOPTS="__REPLACE_ME_WITH_MBL_APP_DIR__/__REPLACE_ME_WITH_bindir__"
